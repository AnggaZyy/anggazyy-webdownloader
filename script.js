...
downloadButton.addEventListener("click", () => {
    ...
    countdown.innerHTML = "Downloaded akan di mulai <span>" + timeleft + " </span> seconds."; // For Fast Start

    var downloadtimer = setInterval(function timecount() {
        timeleft -= 1;
        countdown.innerHTML = "Downloaded akan di mulai <span>" + timeleft + " </span> seconds.";
        if (timeleft <= 0) {
